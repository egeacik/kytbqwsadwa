...
client.on("guildMemberAdd", (member, message) => {
  ...
  const id = "770357007344599080"; //Kanal id
  const jail = "768831943106101268"; //jail rol id
  const kayıtsız = "765459367851458570"; //Kayıtsız rol id
...
Kayıt olmak için <@&765857820007858196> rolündeki yetkilileri etiketlemeyi unutma.`)
